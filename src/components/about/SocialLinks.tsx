...
import { email, aboutLinks,socialLinks } from '@/config/infoConfig'
    ...
    <div>
      <div className="mt-6 flex flex-row flex-wrap justify-center md:justify-start items-center gap-1">
        {socialLinks.map((link) => (
         ...
         <div className="mt-6 flex flex-row flex-wrap justify-center md:justify-start items-center gap-1 border-t">
        {aboutLinks.map((link) => (
          <Link
            key={link.name}
            href={link.href}
